...
<?php include './Links/header.php';?>
    <section class="banner-bg-img position-relative mb-5">
        <img src="./assets/security-banner.png" alt="Banner" width="100%">
        <div class="banner-inner-text centermedia position-absolute">
            <h1 class="banner-heading2 media-size">Information Security Policy</h1>
    ...
    <section class="security-paddingmedia" style="padding: 80px;">

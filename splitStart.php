...
<body>
    ...
    <section class="jumbotron text-center merge-jumbotron mt-2" style="min-height: 500px;">
        <div class="container">
            <h1 class="jumbotron-heading pb-2">Split<span> PDF</span> files</h1>
            <p class="pb-2" style="font-weight: 500;">Split PDF with the easiest PDF Splitter available.</p>
    ...
    $(function() {
        ...
        $("#frmPond").on("submit", (e) => {
            ...
            pond.processFiles().then(files => {
                window.location.replace('split.php');
            });
        });
